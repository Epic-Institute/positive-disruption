...
dash.register_page(
    __name__,
    path="/GHGConcentration",
    title="GHG Concentration",
    name="GHG Concentration",
)
...
dataset = {
    "GHG concentration": "concentration",
}

# define chart output options
chart_output = ["GHG Concentration"]
...
@callback(
    output=Output("graphic-concentration", "figure"),
    inputs=[
        Input("dataset", "value"),
