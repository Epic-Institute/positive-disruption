...
def energy_supply(
    ...
    # For each region, find the historical percent of total heat consumption met by each product

    # Use the historical percent of total heat consumption met by each product to estimate projected percent of total heat consumption each meets

    # Set fossil fuel generation to fill balance of renewables

    # Combine historical and projected heat supply

    # Multiply percent of total heat consumption met by total heat demand
    ...
    # For each region, find the historical percent of total transport consumption met by each product

    # Use the historical percent of total transport consumption met by each product to estimate projected percent of total transport consumption each meets

    # Set fossil fuel generation to fill balance of renewables

    # Combine historical and projected transport supply

    # Multiply percent of total transport consumption met by total transport demand
